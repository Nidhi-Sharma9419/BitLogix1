        ...
        <div className="flex flex-col md:w-[50%] items-center">
          ...
          <div className="flex flex-col ml-12">
            ...
            <div className="flex flex-row space-x-2 mt-2">
              <a href="https://twitter.com/BitLogix_" target="_blank">
                <svg
              ...
              <a href="https://www.youtube.com/@BitLogix.vercel" target="_blank">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="24"
                  height="24"
              ...
              <a href="mailto:bitlogix.vercel@gmail.com" target="_blank">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="24"
                  height="24"
