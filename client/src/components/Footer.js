...
export default function Footer() {
  return (
    <div className="h-auto bg-black text-white">
        ...
        <div className="flex flex-col md:w-[50%] items-center">
          ...
          <div className="flex flex-col ml-12">
            ...
            <div className="flex flex-row space-x-2 mt-2">
              <a href="https://twitter.com/BitLogix_" target="_blank" rel="noreferrer">
                <svg
              ...
              <a href="https://www.youtube.com/@BitLogix.vercel" target="_blank" rel="noreferrer">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="24"
                  height="24"
              ...
              <a href="mailto:bitlogix.vercel@gmail.com" target="_blank" rel="noreferrer">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="24"
                  height="24"
          ...
          <div className="flex flex-col justify-start mt-10 -ml-12">
            ...
            <span className="mt-2">
              <Link to="/team" className="hover:text-sky-200">
                Our Team
              </Link>
            </span>
            <span>
      ...
      <div className="text-center pb-3">© 2023 BitLogiX, Inc. All rights reserved.</div>
    </div>
  );
}
