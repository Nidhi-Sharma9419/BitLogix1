  ...
  return (
    <div className="bg-gray-200 h-screen">
      <section className="mb-32 text-center">
        ...
        <div className="flex justify-center flex-wrap space-x-24">
          <div className="mb-24 md:mb-0 w-80">
            <div className="block h-full rounded-lg bg-white shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] hover:shadow-xl">
              ...
              <div className="p-6">
                <h5 className="mb-4 text-lg font-bold">Hardik Malani</h5>
          ...
          <div className="mb-24 md:mb-0 w-80">
            <div className="block h-full rounded-lg bg-white shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] hover:shadow-xl">
              ...
              <div className="p-6">
                <h5 className="mb-4 text-lg font-bold">Hemanth Bugata</h5>
                <p className="mb-6">Smart Contract Developer</p>
                <ul className="mx-auto flex list-inside justify-center">
                  <a href="#!" className="px-2"></a>
                  <a
                    href="https://twitter.com/HemanthBugata"
                    target="_blank"
                    className="px-2"
                  >
                    <svg
                  ...
                  <a
                    href="https://www.linkedin.com/in/hemanth-bugata-2787b3279/"
                    target="_blank"
                    className="px-2"
                  >
                    <svg
          ...
          <div className="mb-24 md:mb-0 w-80 md:mt-28">
            <div className="block h-full rounded-lg bg-white shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] hover:shadow-xl">
              <div className="flex justify-center">
                <div className="flex justify-center -mt-[75px]">
                  <img
